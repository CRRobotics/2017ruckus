...
//        manager.mapButton(LogitechF310.Buttons.RB, new GearPickup(), JoystickManager.MappingType.WhenReleased);
        manager.mapButton(LogitechF310.Buttons.LeftJoyPress, new ReturnControlToDriver(), JoystickManager.MappingType.WhenPressed);
...
<<<<<<< HEAD
        manager.mapButton(LogitechF310.Buttons.A, new Approach(12,.8), JoystickManager.MappingType.WhenPressed);
=======
        manager.mapButton(LogitechF310.Buttons.A, new Approach(12, .6), JoystickManager.MappingType.WhenPressed);
